...
<body>
	...
	<div class="container">
		<div class = "wrapper">
			...
			<h1 class="pagetitle">
				<a href="chuyenmuc/2/van-hoc-nuoc-ngoai.htm"> Văn học Nước Ngoài </a>
			</h1>
	
			<div class="listbook">
				<div class="wrapper">
					<c:forEach var="b" items="${VHNN}">
						<div class="book">
							<a href="sach.htm?sach=${b.maSach}" title="${b.tenSach}">
								<div class="card mycart" style="width: 210px; height: 360px">
									<img src="files/images/book/${b.photo}" alt="${b.tenSach}" />
			...
			<h1 class="pagetitle">
				<a href="chuyenmuc/3/thieu-nhi.htm"> Thiếu nhi </a>
			</h1>
			<div class="listbook">
				<div class="wrapper">
					<c:forEach var="b" items="${TN}">
						<div class="book">
							<a href="sach.htm?sach=${b.maSach}" title="${b.tenSach}">
								<div class="card mycart" style="width: 210px; height: 360px">
									<img src="files/images/book/${b.photo}" alt="${b.tenSach}" />
			...
			<h1 class="pagetitle">
				<a href="chuyenmuc/4/khoa-hoc-tu-nhien-nhan-van.htm"> Khoa học tự
					nhiên - Nhân văn </a>
			</h1>
