...
<body>
	...
	<div class = "container">
		<div class = "wrapper">
			<div class = page>
				<h1>GIỚI THIỆU</h1>
				<p>Công ty cổ phần Văn hóa và Truyền thông Nhã Nam</p>
				<p>Tháng 2 năm 2005, Nhã Nam, tên đầy đủ là Công ty Cổ phần Văn hóa và Truyền thông Nhã Nam đã gia nhập thị trường sách. 
				Tác phẩm "Balzac và cô bé thợ may Trung hoa" của Đới Tư Kiệt là cuốn sách đầu tiên được những người sáng lập Nhã Nam xuất bản cả trước khi công ty ra đời. 
				Ngay lập tức từ cuốn sách đầu tiên, độc giả đã dành sự quan tâm và yêu mến cho một thương hiệu sách mới mẻ mang trong mình khát vọng góp phần tạo lập diện mạo mới cho xuất bản văn học tại Việt Nam.
				</p>
				<p>Lòng say mê của đội ngũ là viên đá đầu tiên. 
				Trải qua mấy năm phát triển, Nhã Nam đã được xây dựng dần lên trong diện mạo một nhà xuất bản vững chãi và chuyên nghiệp. 
				Sáu tháng sau khi thành lập công ty, Nhật ký Đặng Thùy Trâm ra đời, tạo nên một cơn sốt trong xã hội, với gần 500,000 bản sách được phát hành, phá mọi kỷ lục về xuất bản trước đó, kéo theo một loạt những hiệu ứng xã hội và dư luận có ý nghĩa. 
				Từ đó trở đi, thông qua Nhã Nam, các cuốn sách văn học nước ngoài có giá trị được liên tục mua bản quyền và xuất bản tại Việt Nam, thu hút nhiều tầng lớp độc giả. 
				Sách của Nhã Nam nổi bật bởi nội dung văn học tinh tế, bởi vẻ đẹp của thiết kế hiện đại ở hình thức, bởi sự chăm chút kỹ lưỡng cho mỗi cuốn sách như một con thuyền mang tới niềm vui, tri thức, ngạc nhiên, và đồng cảm.</p>
				<p>
